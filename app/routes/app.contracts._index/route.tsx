...
import {useLoaderData, type ShouldRevalidateFunction, useNavigate} from '@remix-run/react';
import {
  Box,
  Card,
  Divider,
    ...
    <Page title={t('page.title')}>
      <Box paddingBlockEnd="400">
          <ButtonGroup variant="segmented">
            <Button onClick={() => navigate("/app/contracts")} pressed icon={<Icon source={CalendarIcon} />}>Contracts</Button>
            <Button onClick={() => navigate("/app/customers")} icon={<Icon source={ProfileIcon} />}>Customers</Button>
          </ButtonGroup>
      </Box>
